...
const Chat = ({ conversation, handleLatestMsg }) => {
  ...
  useEffect(() => {
    const fetchFirstMessages = async (conversationId) => {
      ...
      const { data } = await axios.get(
        `/conversation/messages/${conversationId}/0`
      );
      setSkip(10);
      return data;
    };
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      const { data } = await axios.get(
        `/conversation/messages/${conversation.id}/${skip}`
      );
    ...
    <div className="chat">
      <div className="chat-container">
        ...
        <div className="chat-view">
          <div
            className={image === null ? "message-view" : "message-viewImage"}
            ref={containerRef}
          >
            {messages &&
          ...
          {conversation?.isFriend ? (
            <div className="chat-box">
              <div className="chat-toolbar">
                <i
                  className="fa-light fa-face-smile-beam"
            ...
            <div className="chat-noFriend">
              Hãy kết bạn với nhau để tiếp tục trò chuyện nhé
            </div>
          )}
        </div>
      </div>
